...
if __name__ == "__main__":
    ...
    dataset_name = "tkgl-concert4"
    ruledataset = RuleDataset(name=dataset_name, large_data_hardcode_flag=False)

    path_rankings = osp.join(osp.dirname(__file__), "..", "files", "rankings", dataset_name, "tkgl-concert420-rankings_test_conf_0_corr_conf_0_noisyor_crules_frules_zrules_pvalue_10_num_top_rules_5_multi.txt")



    scores = evaluate_r_prec(ruledataset, path_rankings, evaluation_mode='test', eval_type='random', rels_of_interest=[7], detailed_results_flag=True)
