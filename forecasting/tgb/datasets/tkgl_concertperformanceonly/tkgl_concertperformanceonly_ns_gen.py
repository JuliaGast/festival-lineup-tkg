...
def main():
    ...
    name = "tkgl-concertperformanceonly"
    ...
    test_timestamps = set(np.array(data.t[test_mask]))
    val_timestamps = set(np.array(data.t[val_mask]))
    print(f"test timestamps: {test_timestamps}")
    print(f"val timestamps: {val_timestamps}")
    print(f"train timestamps: {set(np.array(data.t[train_mask]))}")
