...
def get_args_timetraveler(args=None):
    ...
    # Train Params
    parser.add_argument('--batch_size', default=200, type=int, help='training batch size.') #512
    parser.add_argument('--max_epochs', default=20, type=int, help='max training epochs.') #400
...
def get_args_cen():
    ...
    parser.add_argument("--n-epochs", type=int, default=100, #50, #30,
...
def get_args_regcn():
    ...
    # New best config found: {'n_layers': 2, 'history_len': 4} with val MRR:  0.1076 and val Hits@10:  0.2034
    ...
    parser.add_argument("--batch-size", type=int, default=1,
                        help="batch-size")
    parser.add_argument("-d", "--dataset", type=str, default='tkgl-concertmini',
                        help="dataset to use")
    ...
    # configuration for stat training
    parser.add_argument("--n-epochs", type=int, default=100, #00,
    ...
    parser.add_argument("--train-history-len", type=int, default=4,
                        help="history length")
    parser.add_argument("--test-history-len", type=int, default=4,
                        help="history length for test")
    parser.add_argument("--dilate-len", type=int, default=1,
                        help="dilate history graph")
