...
def baseline_predict(num_queries, test_data, all_data, window, basis_dict, num_nodes, 
                num_rels, lmbda_psi, alpha, evaluator,first_test_ts, neg_sampler, split_mode='test', file=None, write_rankings_flag=False):
    """
    ...
    for j in range(num_this_queries):   
        ...
        if write_rankings_flag: # log rankigns to txt file
